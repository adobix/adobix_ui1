...
class BackgroundPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    drawShape1(canvas, size, paint, Colors.orange.withOpacity(0.8));
    drawShape2(canvas, size, paint, Colors.purple.withOpacity(0.8));
    drawShape3(canvas, size, paint, Colors.blue.withOpacity(0.8));
  }
